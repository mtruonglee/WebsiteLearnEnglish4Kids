                ...
                <Row>
                    <Col xs={12} md={8} style={{ borderRight: 'solid black 1px' }}>
                        ...
                        <Typography variant='h5' component='h1'>
                            Are you looking for an exciting and educational experience for your child? Look no further! Our Kids English Course on the theme of {data.name} is the perfect opportunity for children to embark on a journey of discovery and learning.
                        </Typography>
                        ...
                        <Typography pl={3}>
                            ...
                            <br />
                            2. Language Development: Through exploring the world of {data.name}, children will naturally expand their English vocabulary and improve their language skills. Our curriculum includes a variety of language activities such as storytelling, role-playing, and vocabulary games tailored to the interests and learning styles of young learners.
                            <br />
                            3. Cultural Awareness: Beyond language skills, our course also introduces children to different cultures and habitats around the world. Through learning about {data.name}, children will develop a deeper appreciation for biodiversity and the importance of conservation.
                            <br />
                        ...
                        <Typography pl={3}>
                            1. Introduction to different {data.name}
                            <br />
                            2. Learning new word about {data.name}
                            <br />
                        ...
                        <Typography pl={3}>
                            Our Kid English Course on the theme of {data.name} offers a unique blend of education and entertainment, providing children with the opportunity to expand their English skills while discovering the fascinating world of animals. Enroll your child today and watch them embark on an unforgettable learning adventure!
                        </Typography>
                    </Col>
                    <Col xs={12} md={4}>
